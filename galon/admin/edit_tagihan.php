...
$pembelian = query("SELECT * FROM pesanan WHERE id_pesanan = '$id_pesanan'")[0];
...
if (isset($_POST['edit'])) {
    ...
    echo "
        <script>
            alert('Berhasil Edit Data Tagihan!');
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body p-5">
                                    <h1 class="mb-5">Edit Data Tagihan</h1>
                                    <form action="" method="POST">
                                        <select name="id_user" class="form-control mb-3" required>
                                            <?php
                                            $id_us_detail = $pembelian['id_user'];
                                            $us_detail = query("SELECT * FROM pelanggan WHERE id_user = '$id_us_detail'")[0];
                                            ?>
                                    ...
                                    <br>
                                    <a href="data_tagihan.php">Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div>
