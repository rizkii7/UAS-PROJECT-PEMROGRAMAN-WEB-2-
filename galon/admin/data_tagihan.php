...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * FROM pesanan 
              ...
              WHERE tagihan.pembayaran = 'Belum Bayar' AND pelanggan.nama LIKE '%$keyword%'";
}
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="bayar_tagihan.php?id_pesanan=<?= $td['id_pesanan']; ?>"
                                                            class="btn btn-success mb-2">Bayar Tagihan</a> <br>
